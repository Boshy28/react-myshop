...
const Cart = () => {
  ...
  const removeItem = (id, name) => {
    let res = window.confirm(`Do you really want to remove ${name} from cart?`);
    if (res) dispatch(removeItemFromCart(id));
  };
            ...
            {cart.map((item) => {
              ...
              return (
                <div key={id} className={styles.item}>
                  ...
                  <div className={styles.close} onClick={() => removeItem(item.id, item.title)}>
                    <svg className="icon">
